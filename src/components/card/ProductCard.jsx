...
export default function ProductCard() {
    return (
        <div className="relative w-64 space-y-2 border-r p-2 hover:shadow-2xl  box-border group">
            ...
            <p className="hidden absolute w-full bg-white left-0 right-0 group-hover:block border-t text-xs font-normal text-gray_base text-center py-2 z-10">Compare</p>
        </div>
    )
}
